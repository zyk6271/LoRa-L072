...
void RegionCN470InitDefaults( InitDefaultsParams_t* params )
{
    ...
    switch( params->Type )
    {
        case INIT_TYPE_INIT:
        {
            ...
            NvmCtx.ChannelsDefaultMask[0] = 0x0;
...
bool RegionCN470RxConfig( RxConfigParams_t* rxConfig, int8_t* datarate )
{
    ...
    // Radio configuration
    Radio.SetRxConfig( MODEM_LORA, rxConfig->Bandwidth, phyDr, 1, 0, 8, rxConfig->WindowTimeout, false, 0, true, 0, 0, true, rxConfig->RxContinuous );
